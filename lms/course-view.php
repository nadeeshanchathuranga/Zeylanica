...
<div class="course-view-header">
    <div class="header-content">
        <div class="title-section">
            ...
            <p class="page-subtitle">👨🏫 <?= htmlspecialchars($enrollment['instructor_name'] ?? 'Instructor') ?></p>
        </div>
                    ...
                    <div class="lesson-card <?= $lesson['is_completed'] ? 'completed' : '' ?>">
                        ...
                        <div class="lesson-actions">
                            <?php if (!$isExpired && $enrollment['status'] === 'Active'): ?>
                                <a href="lessons/lesson-watch.php?id=<?= $lesson['id'] ?>" class="btn-watch">
...
<style>
.course-content { max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 2rem; }
...
.course-thumbnail { width: 200px; height: 150px; border-radius: 8px; overflow: hidden; background: #f3f4f6; flex-shrink: 0; }
